...
if ($.isNode()) {
  if (process.env.TXNEWS_COOKIE1 && process.env.TXNEWS_COOKIE1.indexOf('&') > -1) {
      CookieTxnews = process.env.TXNEWS_COOKIE1.split('&');
  } else {
      CookieTxnews = process.env.TXNEWS_COOKIE1.split()
  };
  if (process.env.TXNEWS_SIGN1 && process.env.TXNEWS_SIGN1.indexOf('#') > -1) {
  SignUrl = process.env.TXNEWS_SIGN1.split('#');
  } else {
      SignUrl = process.env.TXNEWS_SIGN1.split()
  };
  if (process.env.TXNEWS_VIDEO1 && process.env.TXNEWS_VIDEO1.indexOf('#') > -1) {
  VideoUrl = process.env.TXNEWS_VIDEO1.split('#');
  } else {
      VideoUrl = process.env.TXNEWS_VIDEO1.split()
  };
